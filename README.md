...
- **[Capstone & Standalone Projects](./mini_projects):** Contains `RecallCLI` (a fully decoupled terminal flashcard engine) and 7 standalone utility scripts demonstrating real-world scripting.
